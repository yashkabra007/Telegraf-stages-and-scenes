...
declare type OptionsFunc = ContextFunc<string[] | {
    [key: string]: string;
}>;
...
export declare function generateSelectButtons(actionBase: string, options: string[], selectOptions: SelectButtonOptions): KeyboardPart;
