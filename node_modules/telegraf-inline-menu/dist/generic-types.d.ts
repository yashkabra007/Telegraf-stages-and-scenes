...
export declare type ContextKeyIndexArrFunc<ReturnType> = (ctx: ContextMessageUpdate, key: string, index: number, array: ReadonlyArray<string>) => ConstOrPromise<ReturnType>;
export {};
